...
\usepackage[hyphenation,homeoarchy,homeoarchywordcolor=orange,homeoarchycharcolor=orange]{impnattypo}%draft
\usepackage{easyReview}

%% para web y corrección
%\usepackage[
...
pdfusetitle,        % Usa \title, \author, etc. para metadatos PDF
...
% referencias
\addbibresource{./files/l-250909VILA.bib}

% agregar paquetes nuevos que sean necesarios
